...
//        var i = arr.find(index)
    ...
    /*ImageParticle{
        ...
        source: picturesList[currentIndex]             // picturesList[Math.floor(Math.random() * picturesList.length)] //'images/Image'+Math.ceil(Math.random()*10)+'.png'
        system: particleSys
    }*/
    ...
    Component {
        ...
        Rectangle {
            id: container
            width: 22*Math.ceil(Math.random()*3); height: width
            color: 'white'
            Image {
                anchors.fill: parent
                anchors.margins: 3
                source: 'images/Image'+Math.ceil(Math.random()*10)+'.png'            //      picturesList[currentIndex]
            }
        }
    }
